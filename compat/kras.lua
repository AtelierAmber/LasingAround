...
if mods["Krastorio2"] then
  ...
  rm.ReplaceIngredient("kr-superior-long-filter-inserter", "processing-unit", "scanner", 1)
  ...
  if data.raw.item["tracker"] then
    ...
    rm.AddIngredient("kr-large-roboport", "tracker", 50)
    ...
    rm.RemoveIngredient("kr-medium-passive-provider-container", "advanced-circuit", 99999)
    rm.RemoveIngredient("kr-medium-active-provider-container", "advanced-circuit", 99999)
    rm.RemoveIngredient("kr-medium-requester-container", "advanced-circuit", 99999)
    rm.RemoveIngredient("kr-medium-buffer-container", "advanced-circuit", 99999)
    rm.RemoveIngredient("kr-medium-storage-container", "advanced-circuit", 99999)
    ...
    rm.RemoveIngredient("kr-big-passive-provider-container", "advanced-circuit", 99999)
    rm.RemoveIngredient("kr-big-active-provider-container", "advanced-circuit", 99999)
    rm.RemoveIngredient("kr-big-requester-container", "advanced-circuit", 99999)
    rm.RemoveIngredient("kr-big-buffer-container", "advanced-circuit", 99999)
    rm.RemoveIngredient("kr-big-storage-container", "advanced-circuit", 99999)
