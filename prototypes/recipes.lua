    ...
    data:extend({
      {
          ...
          results = {{type="fluid", name="kr-hydrogen", amount=200, catalyst_amount=200}, {type="fluid", name="helium", amount=helium_yield}},
          crafting_machine_tint = {
              primary = {1, 0.85, 0.1, 1},
              secondary = {0.75, 1, 0.9, 1},
              tertiary = {1, 1, 1, 0.5},
        ...
        },
        {
          ...
          results = {{type="fluid", name="kr-hydrogen", amount=400, catalyst_amount=400}, {type="fluid", name="helium", amount=helium_yield * 3}, {type="item", name="spectroscope", amount=1, probability=0.99, catalyst_amount=1}, {type="fluid", name="gas", amount=5, catalyst_amount=5}},
          allow_decomposition = false
        }
    })
  end
